...
public class ImgFileListActivity extends BackActivity implements OnItemClickListener{
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		startActivityForResult(intent, Keys.IMG_FILE_LIST_ACTIVITY);
	}
	@Override
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		// TODO Auto-generated method stub
		if (resultCode==Keys.CLOSE_ACTIVITY&&requestCode==Keys.IMG_FILE_LIST_ACTIVITY) {
