package com.halong.aubaby.util.picutil;


import com.halong.aubaby.util.DisplayUtil;
import com.halong.aubaby.util.picutil.ImageDownLoader.OnImageLoaderListener;
...
public class ImageAdapter extends BaseAdapter implements OnScrollListener{
	...
	public ImageAdapter(Context context, NoScrollGridView mGridView, String [] imageThumbUrls,Integer width){
		this.context = context;
		this.mGridView = mGridView;
		this.imageThumbUrls = imageThumbUrls;
		mImageDownLoader = new ImageDownLoader(context);
		DisplayUtil displayUtil=new DisplayUtil();
		int pid=displayUtil.dip2px(context, context.getResources().getDimension(R.dimen.tab2_gridPiding));
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		mImageView.setLayoutParams(new GridView.LayoutParams(picWidth, picWidth));
